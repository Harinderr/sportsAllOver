    ...
    <div
      className={`${
        index == 0
          ...
          : index == 1
          ? "xs:col-span-2 xs:row-span-1"
          : ""
      } group relative min-h-[12rem]  rounded-md`}
    >
      <span className="z-10 text-xs rounded-full capitalize font-normal border-2 text-white  border-blue-400 p-1 absolute right-1 top-1">
        {catSlug}
      </span>
      <Image
