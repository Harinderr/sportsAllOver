...
export const Replies = ({ val, slug, selected, setSelected,type, loadReplies, reply, setReply }) => {
  ...
  <div className="">
   <div
      className={`${styles.comment_container} ${type == 'replies' && 'ml-8' } my-2 rounded-xl bg-bgBlack px-8 py-4 `}>
    ...
    {
                 (
                 val.replies.length > 0 &&  val.replies.map((i) => {
                    return (
                      <Replies
                      key={i.id}
                        val={i}
